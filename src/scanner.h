...
typedef enum
{
  ...
  TOKEN_FLOAT,   TOKEN_STRING,       TOKEN_UNDERSCORE, TOKEN_AS,     TOKEN_BREAK,     TOKEN_CASE,      TOKEN_CONTINUE,
  TOKEN_DEFAULT, TOKEN_DEL,          TOKEN_DO,         TOKEN_ELSE,   TOKEN_FALSE,     TOKEN_FN,        TOKEN_FOR,
  TOKEN_FOREACH, TOKEN_FROM,         TOKEN_IF,         TOKEN_IFBANG, TOKEN_IMPORT,    TOKEN_IN,        TOKEN_LET,
  TOKEN_LOOP,    TOKEN_MUT,          TOKEN_NIL,        TOKEN_RETURN, TOKEN_STRUCT,    TOKEN_SWITCH,    TOKEN_TRUE,
  TOKEN_WHILE,   TOKEN_WHILEBANG,    TOKEN_NAME
} token_type_t;
