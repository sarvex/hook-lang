...
typedef enum
{
  ...
  TOKEN_IF,     TOKEN_IFBANG,       TOKEN_IMPORT,     TOKEN_IN,     TOKEN_LOOP,      TOKEN_MATCH,     TOKEN_MUT,
  TOKEN_NIL,    TOKEN_RETURN,       TOKEN_STRUCT,     TOKEN_TRUE,   TOKEN_VAL,       TOKEN_WHILE,     TOKEN_WHILEBANG,
  TOKEN_YIELD,  TOKEN_NAME
} token_type_t;
